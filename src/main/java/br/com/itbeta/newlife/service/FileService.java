...
public class FileService {
    ...
    public Path save(MultipartFile file, String path) throws IOException {
        Path initiativePath = this.pathRoot.resolve(path).resolve(UUID.randomUUID() + file.getOriginalFilename()).toAbsolutePath();
        OutputStream outputStream = Files.newOutputStream(initiativePath);
